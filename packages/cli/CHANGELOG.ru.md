...
### Изменено
- Синхронизация версии с релизом Open Artifacts 0.11.0. Поведение CLI не менялось; релиз переработал панель просмотра расшаренного артефакта на стороне сервера.
...
### Добавлено
- Синхронизация версии с релизом Open Artifacts 0.10.0.
- Добавлены ключевые слова и метаданные для режима конструктора (`constructor`, `yaml`, `block-builder`).
- Полная совместимость со скриптом сборки `skills/open-artifacts/constructor/build.mjs` для публикации артефактов в одну команду.
