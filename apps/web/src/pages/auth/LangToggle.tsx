...
/** Moved from the former landing (pages/landing/LangToggle.tsx). Same visual shape as
 * `ui/ThemeSwitch` (segmented control), but only two options — kept as its own tiny component
 * rather than generalizing ThemeSwitch to N options for a one-off case. */
export function LangToggle() {
  const { lang, setLang } = useAuthCopy();
  return (
