...
Большинство рабочих настроек — режим регистрации, срок жизни ключей по умолчанию, срок жизни приглашений, список разрешённых CDN и максимальный размер артефакта — можно менять на ходу в разделе **Настройки инстанса** (`/admin/settings`), без переменных окружения и перезапуска.
